...
public class Aerolinea
{
    ...
    public Vuelo getVuelo( String codigoRuta, String fechaVuelo )
    {
    	...
    	for (Vuelo vuelo : vuelos) {
            if (vuelo.getCodigoRuta().equals(codigoRuta) && vuelo.getFechaVuelo().equals(fechaVuelo)) {
                return vuelo;   
        }
            else {
            	return null;	
    ...
    public Collection<Tiquete> getTiquetes( )
    {
    	...
    	ArrayList <Tiquete> lista_total = new ArrayList <Tiquete>();
    	for (Vuelo elemento: vuelos) {
    		lista_total.addAll(elemento.getTiquetes()); 
    	}
        return lista_total;
